package com.restaurant.alvienas.auth;
...
import com.restaurant.alvienas.R;
import com.restaurant.alvienas.model.RegisterResponse;
import com.restaurant.alvienas.utils.DialogUtils;

import static com.restaurant.alvienas.data.Constans.REGISTER;
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(email.getText().toString().equals("")){
                    ...
                    Toast.makeText(RegisterActivity.this, "Nama harus iisi", Toast.LENGTH_SHORT).show();
                }
                else {
                    register();
                }
